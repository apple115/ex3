...
{
    public partial class 教师课程表 : Form
    {
        public string userId;
        public int week;
        public 教师课程表(string userId)
        {
            week = 1;
            InitializeComponent();
            this.userId = userId;
        ...
        private void 教师课程表_Load(object sender, EventArgs e)
        {
        ...
        private void LoadListView(int week)
        {
            try
            {
                DataTable courseData = Tools.Instance.getTeacherCourseDataByUserIdAndWeek(userId, week.ToString());
                // 第一节课
        ...
        private void cb课程表_SelectedIndexChanged_1(object sender, EventArgs e)
        {
